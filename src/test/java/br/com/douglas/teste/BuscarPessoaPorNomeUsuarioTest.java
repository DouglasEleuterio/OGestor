...
public class BuscarPessoaPorNomeUsuarioTest {

    @Test
    public void RealizarTeste() {
        try {
            buscarPessoaPorNomeUsuario("douglas");

        } catch (NoResultException e) {
            System.out.println("Nome de Usuario nao localizado no banco");
        }
    }

    public static Pessoa buscarPessoaPorNomeUsuario(String nomeUsuario) {
        Pessoa pessoa = new Pessoa();
        PessoaService service = new PessoaService();
        pessoa = service.buscarPessoaPorNomeUsuario(nomeUsuario);
